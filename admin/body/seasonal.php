<div class="w-full px-6 py-6 mx-auto min-h-screen">
        <div class="container w-full md:w-4/5 xl:w-full  mx-auto px-2">
            <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                <div class="flex justify-between mb-4">
                  <a href="./loyalty.php" class="flex items-center">
                    <h1 class="capitalize font-bold text-lg underline text-orange-500">go to loyalty discount</h1>
                  </a>
                            ...
                            echo "<tr>";
                              ...
                              echo "<td>";
                                echo "<div class='flex flex-col items-center'>";
                                  echo "<div>";
                                      echo "<button data-id='$result[ID]' data-product-id='$result[productID]' data-percentage='$result[percentage]' data-expiration='$result[expired_at]' data-created='$result[created_at]' data-updated='$result[updated_at]' class='flex py-1 px-2 w-20 bg-yellow-400 items-center rounded-xl hover:rounded-full hover:bg-yellow-600 transition-all duration-300 text-white' onclick='showEditModal(this);'>";
    ...
    <form class="absolute hidden top-0 left-0 w-full h-full edit-modal" method="post" enctype="multipart/form-data" style="z-index: 1000;">
        <input type="hidden" name="id" class="edit-seasonal-id">
          ...
          <div class=" bg-white w-4/5 md:w-1/2 lg:w-1/3 add-modal-scroll fixed animate-drop top-8 left-1/2 -translate-x-1/2 flex flex-col items-center" style="overflow: auto;">
              <div class="grid rounded-lg shadow-xl w-full">
                <div class="grid grid-cols-1 mt-5 mx-7">
                  ...
                  <select class="edit-seasonal-product form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="product" required>
                      <?php
                        $results = allProductAlphabetical();
                        foreach($results as $result){
                ...
                <div class="grid grid-cols-1 mt-5 mx-7">
                    ...
                    <input class="edit-seasonal-percentage form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" type="text" placeholder="Enter percentage" name="percentage" required/>
                </div>
                <div class="grid grid-cols-1 mt-5 mx-7">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Expiration:</label>
                    <input class="edit-seasonal-expiration form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" type="date" name="expiration" required/>
                </div>
        ...
        <div class=" h-full w-full">
          <div class=" bg-white w-4/5 md:w-1/2 lg:w-1/3 add-modal-scroll fixed animate-drop top-8 left-1/2 -translate-x-1/2 flex flex-col items-center" style="overflow: auto;">
              <div class="grid rounded-lg shadow-xl w-full">
                <div class="grid grid-cols-1 mt-5 mx-7">
                  <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">product:</label>
                  <select class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="product" required>
                      <?php
                        $results = allProductAlphabetical();
                        foreach($results as $result){
                          echo "<option value='$result[ID]'>$result[brand]</option>";
                ...
                <div class="grid grid-cols-1 mt-5 mx-7">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Percentage:</label>
                    <input class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" type="text" placeholder="Enter percentage" name="percentage" required/>
                </div>
                <div class="grid grid-cols-1 mt-5 mx-7">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Expiration:</label>
