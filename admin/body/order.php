                ...
                <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                  <thead> 
                        <tr>
                            ...
                            <th data-priority="2">Payment via</th>
                            <!-- <th data-priority="3">full name</th>     -->
                            <th data-priority="4">Ordered at</th>
                        ...
                        <?php
                          ...
                          foreach($results as $result){
                            ...
                            echo "<tr>";
                              ...
                              // echo "<td class='text-center'>$result[firstname] $result[lastname]</td>";
                              echo "<td class='text-center'>$result[ordered_at]</td>";
                              echo "<td class='text-center'>$result[city]</td>";
                              echo "<td class='text-center'>$result[zipcode]</td>";
                              echo "<td class='text-center'>$result[status]</td>";
                              echo "<td>";
                                echo "<div class='flex flex-col items-center'>";
                                  echo "<div>";
                                      echo "<button class='flex py-1 px-2 w-20 bg-yellow-400 items-center rounded-xl hover:rounded-full hover:bg-yellow-600 transition-all duration-300 text-white' onclick=location.href='./order-details.php?id=$result[ID]'>";
