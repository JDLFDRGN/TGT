                    ...
                    <div class="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color">
                                TGT Furniture Shop, Magsaysay Avenue Corner Bañas, General Santos City.
                            </p>
                        </div>
                    </div>
                    <div class="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color">09872837482</p>
                        </div>
                    </div>
                    <div class="flex mb-8 max-w-[370px] w-full">
                        <div
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color">tgtfurnitureshop@gmail.com</p>
                        </div>
                    </div>
                    <div class="flex mb-8 max-w-[370px] w-full">
                        <ul class="flex">
                            <li class="bg-black rounded-full ml-4 overflow-hidden w-8 h-8 grid place-items-center"><a href="#"> <img src="./img/icon/facebook-white.svg" alt="fb" class="w-6 h-6"></a></li>
                            <li class="bg-black rounded-full ml-12 overflow-hidden w-8 h-8 grid place-items-center"><a href="#"> <img src="./img/icon/instagram-white.svg" alt="fb" class="w-6 h-6"></a></li>
                            <li class="bg-black rounded-full ml-12 overflow-hidden w-8 h-8 grid place-items-center"><a href="#"> <img src="./img/icon/youtube-white.svg" alt="fb" class="w-6 h-6"></a></li>
                        </ul>
                    </div>  
                    </div>
                </div>
                    ...
                    <form>
                        <div class="mb-6">
                            <input
                                ...
                                class="
                                form-control block font-normal text-gray-700 bg-white bg-clip-padding border-solid border-gray-300 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
                                w-full
                                rounded
                                py-3
                                px-[14px]
